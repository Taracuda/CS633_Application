...
export const ItemBox: React.FC<ItemBoxProps> = ({itemName, itemDescription, itemId, imageUrl, onDeleteHandler, descriptionChangedHandler, nameChangedHandler}) => {
    const [isEditing, setIsEditing] = useState(false);
    const [displayedItemDescription, setDisplayedItemDescription] = useState(itemDescription);
  ...
  return (
    <>
      <div className="right-item">
          {isEditing && (
              <>
              <input type="text" value={displayedItemName} onChange={(e) => {setDisplayedItemName(e.target.value)}} />
